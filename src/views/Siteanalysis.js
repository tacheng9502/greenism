...
function SiteAnalysis() {
    ...
    const ht_title_1 = "How to do the site analysis?";
    const ht_subtitle_1 = "You may need to consider 5 aspects."
    const ht_title_2 = "Next Chapter"
    const ht_subtitle_2 = "How to design and planning green infrastructures?"
    ...
    return (
        <>
            ...
            <HeroImageLeft title={null} subtitle={null} rows={hil_rows_1} imgWidth={hil_imgWidth} />
            ...
            <HeroImageLeft rows={hil_rows_2} imgWidth={hil_imgWidth} />
